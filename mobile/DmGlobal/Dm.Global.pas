...
type
  ...
  public
    ...
    procedure ConsultarLancamentosId(
...
procedure TDmGlobal.CriarConta(
  nome, email, senha: string
);
var
  resp: IResponse;
...
procedure TDmGlobal.ConsultarLancamentos(
  id_categoria: Integer;
  dt_de, dt_ate: string
);
var
...
procedure TDmGlobal.ConsultarLancamentosId(
  id_lancamento: Integer
);
var
  resp: IResponse;
...
procedure TDmGlobal.ExcluirLancamento(
  id_lancamento: Integer
);
var
  resp: IResponse;
...
procedure TDmGlobal.EditarUsuario(
  nome, email: string
);
var
  resp: IResponse;
